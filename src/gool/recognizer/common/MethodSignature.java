...
public class MethodSignature {
	...
	MethodSignature(String className, String methodName,
			ArrayList<String> paramtypes, String returntype) {
		this.methodname = methodName;
		this.paramtypes = paramtypes;
		this.returntype = returntype;
	}

	// a method signature can be created from a raw string such as:
	// "methodName(int,char):int"
	...
	// 2 signatures are compatible if they have exactly the same return type and
	...
	// 2 signatures are equal if they have exactly the same class name, method
