...
/**
 * This interface is implemented by all things yielding a value in the
 * intermediate language. Because expressions are frequently voided to be used
 * as statements in OO languages, our expressions can also be statements
 * 
 * @param T
 *            is the type of the value, if known at compile time, otherwise put
